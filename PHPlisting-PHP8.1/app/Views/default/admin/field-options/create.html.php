<nav aria-label="breadcrumb">
    <ol class="breadcrumb pl-0 bg-transparent">
        ...
        <li class="breadcrumb-item active" aria-current="page"><?php echo e(__('admin.fieldoptions.'. $view->group->slug . '.breadcrumb.create')); ?></li>
    </ol>
</nav>
<div class="mb-5">
    <h3><?php echo e(__('admin.fieldoptions.' . $view->group->slug . '.heading.create')); ?></h3>
</div>
<div class="row">
    <div class="col-lg-12">
