<nav aria-label="breadcrumb">
    <ol class="breadcrumb pl-0 bg-transparent">
        ...
        <li class="breadcrumb-item active" aria-current="page"><?php echo __('admin.listingfieldoptions.' . $view->group->slug . '.breadcrumb.update', ['singular' => $view->type->name_singular, 'plural' => $view->type->name_plural]); ?></li>
    </ol>
</nav>
<div class="mb-5">
    <h3><?php echo e(__('admin.listingfieldoptions.' . $view->group->slug . '.heading.update', ['singular' => $view->type->name_singular, 'plural' => $view->type->name_plural])); ?></h3>
</div>
<div class="row">
    <div class="col-lg-12">
