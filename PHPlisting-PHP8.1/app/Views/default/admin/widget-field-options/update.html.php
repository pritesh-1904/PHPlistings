<nav aria-label="breadcrumb">
    <ol class="breadcrumb pl-0 bg-transparent">
        ...
        <li class="breadcrumb-item active" aria-current="page"><?php echo e(__('admin.widgetfieldoptions.breadcrumb.update', ['group' => $view->group->name, 'field' => $view->field->label])); ?></li>
    </ol>
</nav>
<div class="mb-5">
    <h3><?php echo e(__('admin.widgetfieldoptions.heading.update', ['group' => $view->group->name, 'field' => $view->field->label])); ?></h3>
</div>
<div class="row">
    <div class="col-lg-12">
