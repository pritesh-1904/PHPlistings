<nav aria-label="breadcrumb">
    <ol class="breadcrumb pl-0 bg-transparent">
        ...
        <li class="breadcrumb-item active"><?php echo e(__('admin.pricings.breadcrumb.create', ['singular' => $view->type->name_singular, 'plural' => $view->type->name_plural, 'product' => $view->product->name])); ?></li>
    </ol>
</nav>
<div class="mb-5">
    <h3><?php echo e(__('admin.pricings.heading.create', ['singular' => $view->type->name_singular, 'plural' => $view->type->name_plural, 'product' => $view->product->name])); ?></h3>
</div>
<div class="row">
    <div class="col-lg-12">
