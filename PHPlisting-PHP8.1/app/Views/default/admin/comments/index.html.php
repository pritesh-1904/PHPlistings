<nav aria-label="breadcrumb">
    <ol class="breadcrumb pl-0 bg-transparent">
        ...
        <li class="breadcrumb-item active" aria-current="page"><?php echo e(__('admin.comments.breadcrumb.index', ['singular' => $view->type->name_singular, 'plural' => $view->type->name_plural, 'review' => $view->review->title])); ?></li>
    </ol>
</nav>
<div class="mb-5">
    <h3><?php echo e(__('admin.comments.heading.index', ['singular' => $view->type->name_singular, 'plural' => $view->type->name_plural, 'review' => $view->review->title])); ?></h3>
</div>
<a href="<?php echo adminRoute($view->type->slug . '-comments/create', ['review_id' => $view->review->id]); ?>" class="btn btn-success btn-lg mb-3"><i class="fas fa-plus"></i> <?php echo e(__('admin.comments.button.create', ['singular' => $view->type->name_singular, 'plural' => $view->type->name_plural])); ?></a>
<div class="row">
    <div class="col-lg-12">
