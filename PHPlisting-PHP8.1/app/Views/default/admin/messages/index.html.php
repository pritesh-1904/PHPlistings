<nav aria-label="breadcrumb">
    <ol class="breadcrumb pl-0 bg-transparent">
        ...
        <?php } ?>
        <li class="breadcrumb-item active"><?php echo e(__('admin.messages.breadcrumb.index', ['singular' => $view->type->name_singular, 'plural' => $view->type->name_plural])); ?></li>
    </ol>
</nav>
<div class="mb-5">
    <h3><?php echo e(__('admin.messages.heading.index', ['singular' => $view->type->name_singular, 'plural' => $view->type->name_plural])); ?></h3>
</div>
<div class="clearfix mb-3">
    <a href="<?php echo adminRoute($view->type->slug . '-messages/create', ['listing_id' => request()->get->get('listing_id')]); ?>" class="btn btn-success btn-lg mb-3 float-left"><i class="fas fa-plus"></i> <?php echo e(__('admin.messages.button.create', ['singular' => $view->type->name_singular, 'plural' => $view->type->name_plural])); ?></a>
