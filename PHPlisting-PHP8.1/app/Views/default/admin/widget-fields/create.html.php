<nav aria-label="breadcrumb">
    <ol class="breadcrumb pl-0 bg-transparent">
        ...
        <li class="breadcrumb-item active" aria-current="page"><?php echo __('admin.widgetfields.breadcrumb.create', ['group' => $view->group->name]); ?></li>
    </ol>
</nav>
<div class="mb-5">
    <h3><?php echo e(__('admin.widgetfields.heading.create', ['group' => $view->group->name])); ?></h3>
</div>
<div class="row">
    <div class="col-lg-12">
