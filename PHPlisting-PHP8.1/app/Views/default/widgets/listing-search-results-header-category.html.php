<?php
    ...
    if ('' != $view->data->category->get('header_id', '') && null !== $view->data->category->header && false !== $view->data->category->header->isImage()) {
        $header = $view->data->category->header;
...
<?php } ?>
<section class="widget listing-search-results-header-category-widget <?php echo $view->settings->colorscheme; ?> py-6">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h1 class="text-bold">
                    <?php echo e($view->data->category->name); ?>
                </h1>
                <?php if ('' != $view->data->category->description) { ?>
                <p class="text-thin display-9 mt-4">
                    <?php echo d($view->data->category->description); ?>
                </p>
