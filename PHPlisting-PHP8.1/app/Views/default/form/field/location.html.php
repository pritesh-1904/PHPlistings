...
<select<?php echo $view->attributes; ?>>
    <?php if (null !== $view->value && null !== $location = \App\Models\Location::find($view->value)) { ?>
        <option value="<?php echo e($view->value); ?>" selected><?php echo $location->ancestorsAndSelfWithoutRoot()->get(['id', 'name'])->pluck('name')->implode('&raquo;'); ?></option>
    <?php } ?>
</select>
